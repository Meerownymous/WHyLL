...
//{
//	public sealed class AsRequestInput : IMessageInput
//	{
...
//        public IMessage WriteTo(IMessage request)
//        {
...
//        public static IMessageInput _(params IPair<string, string>[] parts) =>
//            new AsRequestInput(parts);

//        public static IMessageInput _(IEnumerable<IPair<string, string>> parts) =>
//            new AsRequestInput(parts);
//    }
//}
